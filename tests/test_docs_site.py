...
class DocsSiteTests(unittest.TestCase):
    def test_landing_page_links_product_surface(self):
        ...
        self.assertIn("StateBind Guard v0.1.26", html)
        ...
        self.assertIn("https://github.com/FU-max-boop/statebind-guard/releases/tag/v0.1.26", html)
    ...
    def test_readme_points_to_project_page(self):
        ...
        self.assertIn("statebind audit --repo-url", readme)
        self.assertIn("statebind scout", readme)
    ...
    def test_launch_package_contains_outreach_material(self):
        ...
        self.assertIn("statebind audit --repo-url", package)
        self.assertIn("statebind scout", package)
    ...
    def test_external_adoption_receipt_is_linked(self):
        ...
        self.assertIn("FU-max-boop/statebind-guard@v0.1.26", industrial)
        self.assertIn("FU-max-boop/statebind-guard@v0.1.26", action_usage)
    ...
    def test_adoption_audit_doc_has_first_pr_flow(self):
        ...
        self.assertIn("--repo-url", audit)
        self.assertIn("statebind scout", audit)
