...
class DocsSiteTests(unittest.TestCase):
    def test_landing_page_links_product_surface(self):
        ...
        self.assertIn("StateBind Guard v0.1.22", html)
        ...
        self.assertIn("FU-max-boop/statebind-guard@v0.1.22", html)
        ...
        self.assertIn("https://github.com/FU-max-boop/statebind-guard/releases/tag/v0.1.22", html)
    ...
    def test_external_adoption_receipt_is_linked(self):
        ...
        self.assertIn("FU-max-boop/statebind-guard@v0.1.22", industrial)
        self.assertIn("FU-max-boop/statebind-guard@v0.1.22", action_usage)
