...
class DocsSiteTests(unittest.TestCase):
    def test_landing_page_links_product_surface(self):
        ...
        self.assertIn("StateBind Guard v0.1.38", html)
        ...
        self.assertIn("FU-max-boop/statebind-guard@v0.1.38", html)
        ...
        self.assertIn("--github-list", html)
        ...
        self.assertIn("capture-worktree", html)
        self.assertIn("statebind init", html)
        self.assertIn("--policy-out", html)
        self.assertIn("--pre-commit-config", html)
        ...
        self.assertIn("https://github.com/FU-max-boop/statebind-guard/releases/tag/v0.1.38", html)
    ...
    def test_readme_points_to_project_page(self):
        ...
        self.assertIn("docs/adoption_context_evidence_2026_05_31.md", readme)
        ...
        self.assertIn("--policy-out", readme)
        self.assertIn("--pre-commit-config", readme)
        ...
        self.assertIn("--github-repo", readme)
        self.assertIn("--result-card", readme)
        ...
        self.assertIn("--run-url", readme)
        self.assertIn("capture-worktree", readme)
        self.assertIn("--active-file", readme)
    ...
    def test_launch_package_contains_outreach_material(self):
        ...
        self.assertIn("--github-list", package)
        self.assertIn("--result-card", package)
        ...
        self.assertIn("--run-url", package)
        self.assertIn("capture-worktree", package)
        ...
        self.assertIn("adoption_context_evidence_2026_05_31.md", package)
        self.assertIn("adoption_feedback_requests_2026_05_31.md", package)
    ...
    def test_external_adoption_receipt_is_linked(self):
        ...
        self.assertIn("--run-url", action_usage)
        self.assertIn("capture-worktree", action_usage)
    ...
    def test_handoff_contract_documents_runtime_capture(self):
        ...
        self.assertIn("--run-url", contract)
        self.assertIn("capture-worktree", contract)
        self.assertIn("git_worktree", contract)
        self.assertIn("ci_run_conclusion", contract)
    ...
    def test_adoption_audit_doc_has_first_pr_flow(self):
        ...
        self.assertIn("--github-list", audit)
        self.assertIn("--result-card", audit)
        self.assertIn("--issue-context-card", audit)
        self.assertIn("--issue-context-term", audit)
        self.assertIn("--feedback-packet", audit)
        self.assertIn("maintainer_feedback/pydantic_ai_feedback_packet_2026_05_31.md", audit)
        self.assertIn("GH_TOKEN", audit)
